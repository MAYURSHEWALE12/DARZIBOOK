      ...
      <div className="w-full max-w-md bg-white rounded-[24px] sm:rounded-[36px] shadow-2xl p-6 sm:p-8 relative z-10 border border-white/50 mt-8 sm:mt-0">
        ...
        <div className="text-center mb-5 sm:mb-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-800 tracking-tight mb-1 sm:mb-2">
            Welcome <span className="text-[#1e3a8a]">Back</span>
          </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center space-x-2 cursor-pointer group">
              <input type="checkbox" className="w-4 h-4 rounded border-slate-300 text-[#1e3a8a] focus:ring-[#1e3a8a] focus:ring-offset-0 bg-white cursor-pointer transition-colors" />
              <span className="text-xs sm:text-sm font-medium text-slate-500 group-hover:text-slate-700 transition-colors">Remember me</span>
            </label>
            <a href="#" className="text-xs sm:text-sm font-bold text-[#1e3a8a] hover:text-[#152a66] transition-colors">
              Forgot password?
            </a>
          </div>
        ...
        <p className="text-center text-xs sm:text-[15px] text-slate-500">
          ...
          <Link to="/register" className="font-bold text-[#1e3a8a] hover:text-[#152a66] transition-all">
            Register
          </Link>
        </p>
      </div>
