          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="space-y-1">
                ...
                <div 
                  className="relative flex items-center w-full h-12 rounded-lg border border-slate-200 focus-within:ring-1 focus-within:ring-[#1e3a8a] focus-within:border-[#1e3a8a] transition-all overflow-hidden bg-white cursor-text"
                  onClick={() => document.getElementById('deliveryDateInput')?.showPicker?.()}
                >
                  <div className="h-full px-4 flex items-center justify-center bg-slate-50 border-r border-slate-200">
