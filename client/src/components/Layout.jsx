              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive 
                      ? 'bg-gradient-to-r from-[#2596be]/20 to-transparent text-white border border-[#2596be]/20 shadow-inner' 
                      : 'text-white/70 hover:bg-white/5 hover:text-white'
                  )}
                >
                  {isActive && <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#2596be] rounded-r-full shadow-[0_0_10px_#2596be]" />}
